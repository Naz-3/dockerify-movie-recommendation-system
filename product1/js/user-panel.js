document.addEventListener("DOMContentLoaded", async () => {
    ...
    window.toggleWatchlist = function(id) {
        id = Number(id);
        watchlist = watchlist.includes(id) ? watchlist.filter(wId => wId !== id) : [...watchlist, id];
    ...
    function createCard(item) {
        ...
        return `
            <div class="media-card" data-id="${itemId}" onclick="window.openDetailModal(${itemId})">
                ...
                <div class="card-body">
                    ...
                    <div class="card-actions" onclick="event.stopPropagation();">
                        <button class="btn-action ${isFav ? 'active-fav' : ''}" onclick="window.toggleFavorite(${itemId})">
                            ${isFav ? '💖 Favoride' : '❤️ Favori'}
                        </button>
                        <button class="btn-action ${isWatch ? 'active-watch' : ''}" onclick="window.toggleWatchlist(${itemId})">
