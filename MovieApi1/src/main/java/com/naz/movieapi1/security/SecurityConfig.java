...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // Frontend ve Swagger için CORS izni
    ...
    // CORS Yapılandırması (Frontend servisinizin rahatça istek atabilmesi için)
    @Bean
